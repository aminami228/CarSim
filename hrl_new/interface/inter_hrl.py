...
class InterSim(object):
    ...
    def draw_scenary(self, av, hvs, fvs, h, a, r=0):
        if self.Visual:
            ...
            plt.text(av['x'], av['y'], 'a: [{0:.0f}, {1:.2f}]'.format(h, a) + ', v: {0:.2f}'.format(av['vy']) +
    ...
    def update_vehicle(self, h, a=0, r=0, st=0):
        if h == 0:
        ...
        if self.Visual:
            self.draw_scenary(self.av_pos, self.hv_poses, self.fv_poses, h, accel, r)
