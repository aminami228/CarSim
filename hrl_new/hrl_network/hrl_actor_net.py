...
class HrlActorNetwork(object):
    ...
    def create_actor_network(state_size):
        ...
        ac = Dense(3, activation='softmax')(h3)
        a1 = Dense(2, activation='sigmoid', kernel_initializer=RandomNormal(mean=0.0, stddev=1e-4, seed=None))(h3)
        a2 = Dense(1, activation='tanh', kernel_initializer=RandomNormal(mean=0.0, stddev=1e-4, seed=None))(h3)
