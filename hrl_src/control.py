...
from ctypes import Structure, c_ushort, c_char, c_uint
...
class SimVires(object):
    ...
    def restart_sim():
        ...
        msg_text = "<SimCtrl><LoadScenario filename=\"" \
                   "/home/member/Documents/VTD/Data/Projects/Current/Scenarios/test.xml\"/></SimCtrl>"
        scp_msg.dataSize = len(msg_text)
        SCP_sock.send(bytearray(scp_msg) + bytearray(msg_text))
        ...
        msg_text = "<Camera name=\"VIEW_CAMERA\" showOwner=\"true\"><Frustum far=\"1500.000000\" fovHor=\"40.000000\" " \
                   "fovVert=\"30.000000\" near=\"1.000000\" offsetHor=\"0.000000\" offsetVert=\"0.000000\" " \
                   "/><PosRelative player=\"AV\" dx=\"-30\" dy=\"0.000000\" dz=\"25\"/><ViewRelative dh=\"0.000000\" " \
                   "dp=\"0.6\" dr=\"0\" /><Set target=\"AV\"/></Camera>"
        scp_msg.dataSize = len(msg_text)
        SCP_sock.send(bytearray(scp_msg) + bytearray(msg_text))
