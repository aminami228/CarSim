...
def playGame(train_indicator=0):  # 1 means Train, 0 means simply Run
    ...
    for e in range(episode_count):
        ...
        # reward_t, collision_t = intersection.reward_function(0)
        # if Visual:
        #     plt.pause(0.1)
        #     plt.clf()
        ...
        for j in range(max_steps):
            ...
            noise_t[0][4] = train_indicator * max(epsilon, 0) * OU.function(action_t_original[0][4], -0.10, intersection.Max_Acc, 2.00)
            noise_t[0][5] = train_indicator * max(epsilon, 0) * OU.function(action_t_original[0][5], 0.10, -intersection.Max_Acc, 2.00)
            ...
            if choose_action == 0:
                ...
                for ts in range(time_step):
                    ...
                    state_t = state_t1
                    step += 1
                    print("Approach Process (", approach_acc, ", ", approach_time, ") ", "AV = ", intersection.av_x, intersection.av_y,
                ...
                if choose_action ==1:
                    ...
                    for ts in range(time_step):
                        ...
                        state_t = state_t1
                        step += 1
                        print("Observe Process (", observe_time, ") ", "AV = ", intersection.av_x, intersection.av_y,
                              "Velocity = ", intersection.av_velocity,
                              "Episode", e, "Step", step, "Reward", reward, "Loss", loss)
                        ###########################################################
                        if intersection.av_x < intersection.Pass_Intersection or collision > 0:
                            done = True
                            break
                    ...
                    if choose_action ==2:
                        ...
                        for ts in range(time_step):
                            ...
                            state_t = state_t1
                            step += 1
                            print("Wait Process (", wait_time, ") ", "AV = ", intersection.av_x, intersection.av_y,
                                  "Velocity = ", intersection.av_velocity,  "Head Angle", intersection.head_angle,
                                  "Episode", e, "Step", step, "Reward", reward, "Loss", loss)
                        ...
                        for ts in range(time_step):
                            ...
                            state_t = state_t1
                            step += 1
                            print("Traverse Process (", tranverse_acc, ", ", tranverse_time, ") ", "AV = ", intersection.av_x, intersection.av_y,
                                  "Velocity = ", intersection.av_velocity,
                                  "Episode", e, "Step", step, "Reward", reward, "Loss", loss)
