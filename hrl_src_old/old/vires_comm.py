            ...
            for n in range(n_elements):
                ...
                if entry.pkgId == 9: # RDB_PKG_ID_OBJECT_STATE
                    ...
                    if data.name == AV_NAME:
                        ...
                        vehicle_state['v'] = data.speed.y
                        #print "speed:",data.speed.x,data.speed.y,data.speed.z
                    ...
                    #print "category:", data.category,"type:",data.type,"flags:",data.flags,"id:",data.id,"sensor id:",data.sensorId,"dist:",data.dist, "sensorPos x:",data.sensorPos.x,"sensorPos y:",data.sensorPos.y,"sensorPos z:",data.sensorPos.z,"sensorPos h:",data.sensorPos.h,"occlusion:",data.occlusion,"spare0:",data.spare0[0],data.spare0[1],data.spare0[2],"spare:",data.spare[0],data.spare[1],data.spare[2]
