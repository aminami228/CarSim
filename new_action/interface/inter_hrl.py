...
class InterSim(object):
    ...
    def update_vehicle(self, j, r=0, st=0):
        jerk = j * self.Tau
        ...
        if self.av_pos['vy'] < 0.0:
            ...
            t = abs(self.av_pos['vy'] / self.av_pos['accel'])
        ...
        if self.Visual:
            self.draw_scenary(self.av_pos, self.hv_poses, self.fv_poses, self.av_pos['accel'], r)
